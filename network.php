    ...
    <div class="topology-stage" data-topology-stage>
      ...
      <svg class="topology-links" viewBox="0 0 1000 650" preserveAspectRatio="none" aria-hidden="true">
        ...
        <g class="topology-line workload" data-path-line="public lab">
          <path d="M415 495 C440 525 468 550 500 575"></path>
          <text x="426" y="542">VMs / LXCs</text>
        </g>
      ...
      <div class="topology-node-layer">
        ...
        <button class="topology-zone zone-admin" type="button" data-network-node="admin" data-path-node="admin" aria-pressed="false">
        ...
        <button class="topology-zone zone-cyberlab" type="button" data-network-node="cyberlab" data-path-node="lab" aria-pressed="false">
