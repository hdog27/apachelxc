  ...
  <section class="project-grid" aria-label="Project list">
    ...
    <article class="project-card card">
      <div class="project-copy">
        ...
        <p class="project-history">The embedded README documents the current OPNsense architecture, encrypted-egress and remote-access paths, and operational tradeoffs. For the complete rack context, see <a href="/homelab">the homelab overview</a>.</p>
